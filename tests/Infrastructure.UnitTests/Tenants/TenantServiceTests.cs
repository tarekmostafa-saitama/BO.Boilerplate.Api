...
public class TenantServiceTests
{
    public TenantSettings TenantSettings = new()
    {
        ...
        {
            new Tenant {Name = "TenantName1", TenantId = "Tenant1", ConnectionString = "Connection1", DbProvider = "mssql"},
            new Tenant {Name = "TenantName2", TenantId = "Tenant2", ConnectionString = "Connection2",DbProvider = "mysql" },
            new Tenant {Name = "TenantName3", TenantId = "Tenant3" }
        }
    };
    [Theory]
    ...
    public void Constructor_WithValidTenantHeader_SetsCurrentTenantSuccessfully(string tenantHeader, string connectionString, string provider)
    {
        // Arrange
